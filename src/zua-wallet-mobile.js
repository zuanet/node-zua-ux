...
export class ZuaWalletMobile extends ZuaWalletUI{
	...
	render(){
		...
		let donationAddresses = [
			["Devfund donations:", "zua:precqv0krj3r6uyyfa36ga7s0u9jct0v4wg8ctsfde2gkrsgwgw8jgxfzfc98"],
			["Mining address:", "zua:pzhh76qc82wzduvsrd9xh4zde9qhp0xc8rl7qu2mvl2e42uvdqt75zrcgpm00"],
			//["KDX/WebWallet donations:", "zua:qrncjga8hej9q59q85ge5js6m4y97el6ahp3m87hyzqdtaq6pf0v7xek7x900"],
		]
	...
	openAddressExplorer(address){
		if (!address)
			return
		let url = `https://explorer.zua.org/addresses/${address}`;
